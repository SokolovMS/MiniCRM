...
namespace MiniCRM.Repository
{
    class ProjectRepository
    {
        ...
        public ProjectRepository()
        {
            ...
            Add(new Project("iOS QDR",      sr.Get(3), cr.Get(0), new DateTime(2015, 12, 11)));
            Add(new Project("iOS CDR",      sr.Get(2), cr.Get(0), new DateTime(2015, 12, 11)));
            Add(new Project("Punch List",   sr.Get(1), cr.Get(0), new DateTime(2015, 12, 11)));
            Add(new Project("Dodo IS",      sr.Get(3), cr.Get(1)));
            Add(new Project("PJM",          sr.Get(3), cr.Get(2)));
            Add(new Project("Kinect",       sr.Get(1), cr.Get(3), new DateTime(2015, 12, 11)));
            Add(new Project("Android-Касса",sr.Get(0), cr.Get(4), new DateTime(2015, 12, 11)));
